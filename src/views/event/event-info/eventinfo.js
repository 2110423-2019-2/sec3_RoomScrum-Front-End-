    ...
    <div>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <p class="border border-primary ">
                ...
                gravida finibus neque, sit amet ornare eros tristique
                condimentum. Quisque egestas a risus vitae lacinia. Cras quam
                arcu, pretium eget semper vitae, malesuada at dui. Donec
                volutpat nunc mauris, id varius mauris aliquam vel. Duis
                scelerisque purus nec feugiat pellentesque. Vestibulum efficitur
                libero in nunc dapibus laoreet. Donec quis ex id nisl convallis
                luctus nec sit amet dui. Nunc eu mi ultricies, interdum dui ac,
                auctor magna. Quisque pretium magna accumsan metus aliquet, in
                mollis mi aliquam.
              </p>
            </div>
          </div>
      ...
      <div class="col-md-3 border border-primary">
        <ul className="nav nav-pills nav-stacked justify-content-center ">
          <Link to="/event/info/1" className="active">
            <a href="#">Event Info</a>
          </Link>
        </ul>
      </div>
