...
const UserItem = ({onViewMusician, userInfo}) => {
    const {userId, firstName, lastName, gender, birthdate, bio, tags = ["foo", "bar", "baz"]} = userInfo;
    ...
    return (
        <div className="user-item card">
            <div className="text-center">
                <img src={profileImage} className="card-img-top rounded-circle p-3 d-inline-block" alt="..."/>
            </div>
